...
程序默认以极简信息条显示在桌面右上角，每 5 分钟自动刷新，只保留今日用量、同步状态、展开和隐藏。点击 `+` 或双击小窗可展开完整视图；顶部“概览 / 任务”可切换统计内容，在任务排行中点击某个任务查看每轮明细和提示词摘要。点击“小窗关注”后，收起窗口即可逐轮查看该任务；滚轮或左右箭头切换轮次，点击数字左侧可在任务轮次与今日总量之间切换。托盘菜单“**小窗显示**”也可以选择显示模式。
